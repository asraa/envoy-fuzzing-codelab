...
public:
  ...
  Http::FilterHeadersStatus encodeHeaders(Http::HeaderMap& header_map, bool) override {
    const Http::HeaderEntry* entry_content = header_map.get(Envoy::Http::LowerCaseString("content_size"));
    const Http::HeaderEntry* entry_added = header_map.get(Envoy::Http::LowerCaseString("added_size"));
    ...
    const Http::HeaderEntry* entry_buffer = header_map.get(Envoy::Http::LowerCaseString("buffer_limit"));
